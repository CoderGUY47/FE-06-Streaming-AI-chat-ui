      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold text-white font-mono">live-agent.ts</span>
          </div>
        ...
        <div className="font-mono text-[11px] text-indigo-200 leading-relaxed bg-black/40 p-2.5 rounded-[4px] backdrop-blur-md">
          <span className="text-purple-400">const</span> agent = <span className="text-purple-400">new</span> OxieStream(&#123;<br />
          &nbsp;&nbsp;model: <span className="text-emerald-300">&quot;oxie-3.7-sonnet&quot;</span>,<br />
          &nbsp;&nbsp;effort: <span className="text-emerald-300">&quot;high&quot;</span>,<br />
          &#125;);
        </div>
      </motion.div>
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="text-xs font-extrabold text-white">45ms Latency</span>
            <span className="text-[11px] text-slate-300">Instant stream responses</span>
          </div>
        </div>
        <div className="h-px bg-white/10 w-full" />
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-[4px] bg-purple-500/30 flex items-center justify-center text-purple-300 shrink-0">
            <FiCpu className="w-4 h-4" />
          </div>
          <div className="flex flex-col">
            <span className="text-xs font-extrabold text-white">99.8% Accuracy</span>
            <span className="text-[11px] text-slate-300">Validated code generation</span>
          </div>
        </div>
      </motion.div>
    </div>
